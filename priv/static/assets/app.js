  ...
  Hooks2.PlayScale = {
    ...
    playScale() {
      if (this.action === "Stop") {
        ...
        this.timeouts = notes.map((note, i3) => setTimeout(() => {
          if (i3 > 0) {
            this.allNotes[i3 - 1].classList.remove("glow");
          }
          this.allNotes[i3].classList.add("glow");
          note.play();
        }, 750 * i3 + 100));
